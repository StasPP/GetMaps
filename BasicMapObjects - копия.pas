...
var
 //// Objects
  ...
  RoutesX2Tab, RoutesY2Tab, RoutesZ2Tab, RoutesBEKind, RoutesRSpacer :Integer;
   ...
   try
     ...
     begin
       ...
       Begin
         ...
         Route[J].GWPT[Length(Route[J].GWPT)-1].x := B;    /// œÓÏÂÊÛÚÓ˜Ì‡ˇ
