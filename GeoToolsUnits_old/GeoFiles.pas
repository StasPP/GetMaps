...
uses GeoClasses, GeoFunctions, GeoString, Classes;
  ...
  function GeoInit(FileName:String):String;
...
Begin
 ...
 try
   ...
   Result := CreateCoordinateSystem(Name, Filename, Capt, DatumName, Cat, Proj);
