...
procedure TGetMapPos.Image2MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
  Image1.OnMouseMove(nil, Shift, X+Image2.Left-Image1.Left, Y +Image2.Top - Image1.Top);
end;

procedure TGetMapPos.Image2MouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  Image1.OnMouseUp(nil,Button,Shift, X+Image2.Left-Image1.Left, Y +Image2.Top - Image1.Top);
end;

procedure TGetMapPos.Label2MouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
begin
  Image1.OnMouseMove(nil, Shift, X+Label2.Left-Image1.Left, Y +Label2.Top - Image1.Top);
end;

procedure TGetMapPos.Label2MouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
  Image1.OnMouseUp(nil, Button, Shift, X+Label2.Left-Image1.Left, Y +Label2.Top - Image1.Top);
end;
